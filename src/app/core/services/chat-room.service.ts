...
export class ChatRoomService {
  ...
  getUserChatRoom(id: string): Observable<ServerResponse<ChatRoom>> {
    return this.http.get<ServerResponse<ChatRoom>>(userChatRoomEndpoint + id);
  }
}
